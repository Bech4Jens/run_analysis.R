...
X_test <- read.table("C:/test/X_test.txt", quote="\"")
y_test <- read.table("C:/test/y_test.txt", quote="\"")
subject_train <- read.table("C:/train/subject_train.txt", quote="\"")
X_train <- read.table("C:/train/X_train.txt", quote="\"")
y_train <- read.table("C:/train/y_train.txt", quote="\"")

features <- read.table("C:/features.txt", quote="\"")
activity_labels <- read.table("C:/activity_labels.txt", quote="\"")
...
write.table(DataMeanStd, "C:/DataMeanStd.txt" , sep = ";")
...
library("reshape2", lib.loc="C:/library")
...
write.table(AveLabAct, "C:/AveLabAct.txt" , sep = ";")
